...
X_test_submit=df_train[['Pclass','SibSp','Parch','Sex']]
y_test_submit=df_train[['PassengerId']]
...
from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test=train_test_split(X_test_submit,y_test_submit, test_size=0.2, random_state=0)
...
from sklearn.neighbors import KNeighborsClassifier
model=KNeighborsClassifier()
model.fit(X_test_submit, y_test_submit)
print(model.score(X_test_submit, y_test_submit))